...
import WalletConnect from '../wallet-connections';
...
describe('WalletConnect Component', () => {
  it('renders connect button with correct text', () => {
    (require('wagmi').useAccount as jest.Mock).mockReturnValue({ isConnected: false });
    (require('wagmi').useConnect as jest.Mock).mockReturnValue({ connectors: [] });
    (require('wagmi').useDisconnect as jest.Mock).mockReturnValue({});
